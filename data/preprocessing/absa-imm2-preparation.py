...
train_file = "../data/raw/ABSAbank-Imm_train.jsonl"
test_file = "../data/raw/ABSAbank-Imm_test.jsonl"
dev_file = "../data/raw/ABSAbank-Imm_dev.jsonl"
...
df["label"] = df["label"].replace(["2.0", "3.0", "4.0", "5.0"], ["0.0", "1.0", "2.0", "2.0"]) # Normalize 1-5 values on a 1-3 scale where 0 is negative, 1 is neutral and 2 is positive
...
df.to_csv("../data/processed/absa-imm.csv") # Save as csv

# Note to self
# Removed first column id in terminal after script execution
