...
# Load the datasets
dataset1 = datasets.load_dataset('csv', data_files='/home/hilhag/prjs/robustly-sentimental/data/processed/absa-imm.csv')['train']
dataset2 = datasets.load_dataset('csv', data_files='/home/hilhag/prjs/robustly-sentimental/data/processed/twitter-data.csv')['train']
...
#dataset = dataset1.shuffle().train_test_split(test_size=0.2['train'].select(range(500)).concatenate(dataset2.shuffle().train_test_split(test_size=0.2)['train'].select(range(200))))
